      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center space-y-4 sm:space-y-6">
          ...
          <div className="pt-4 sm:pt-6 flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <Link href="/category/saree" className="w-full sm:w-auto px-8 py-3 sm:py-4 bg-orange-700 hover:bg-orange-800 text-white font-bold rounded-lg transition-all shadow-lg hover:shadow-xl active:scale-95 text-center">
              Shop Now
            </Link>
            <Link href="/category/chudithar" className="w-full sm:w-auto px-8 py-3 sm:py-4 border-2 border-orange-500 text-orange-500 hover:bg-orange-50 font-bold rounded-lg transition-all text-center">
              View Collection
            </Link>
          </div>
        </div>
