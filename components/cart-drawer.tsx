...
export function CartDrawer() {
  ...
  // Initial focus for screen readers when cart opens
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div 
        ...
        className="fixed right-0 top-0 h-screen w-full max-w-sm bg-white shadow-xl z-50 flex flex-col animate-slide-in"
      >
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 className="text-xl font-bold text-black" id="cart-drawer-title">Shopping Cart</h2>
          <button 
