...
export default function OrdersPage() {
    ...
    const { orders, loading, error, loadMore, hasMore } = useAdminOrders({
        status,
        search,
        dateRange,
    })
                        ...
                        {hasMore && (
                            <div className="p-6 text-center border-t border-gray-100">
                                <button
                                    onClick={loadMore}
                                    disabled={loading}
                                    className="px-6 py-2.5 bg-white border-2 border-orange-500 text-orange-600 font-semibold rounded-lg hover:bg-orange-50 transition-colors disabled:opacity-50"
                                >
