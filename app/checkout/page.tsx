...
function CheckoutContent() {
    ...
    const validateForm = (): boolean => {
        ...
        if (!formData.zipCode?.trim()) { errors.zipCode = "Pin code is required"; isValid = false }
        if (!formData.agreedToTerms) { errors.agreedToTerms = "Please agree to terms and conditions" as any; isValid = false }
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                        <div className="sm:col-span-2">
                                            ...
                                            <input
                                                ...
                                                required
                                                className={`w-full px-4 py-3 border ${formErrors.fullName ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent`}
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                required
                                                className={`w-full px-4 py-3 border ${formErrors.phone ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent`}
                                        ...
                                        <div className="sm:col-span-2">
                                            ...
                                            <textarea
                                                ...
                                                required
                                                rows={3}
                                                className={`w-full px-4 py-3 border ${formErrors.address ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none`}
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                required
                                                className={`w-full px-4 py-3 border ${formErrors.city ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent`}
                                                placeholder="City"
                                            />
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                required
                                                className={`w-full px-4 py-3 border ${formErrors.zipCode ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent`}
                                ...
                                <div className="bg-white rounded-xl shadow-sm p-6">
                                    <label className="flex items-start gap-3 cursor-pointer">
                                        ...
                                        />
                                        <span className={`text-sm ${formErrors.agreedToTerms ? 'text-red-600 font-medium' : 'text-gray-700'}`}>
